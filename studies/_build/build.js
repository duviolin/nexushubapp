...
const articles = [
  ...
  { frag: '05-play-store.html',   emoji: '🚀', nav: 'Publicar na Google Play',       desc: 'Da conta de desenvolvedor à faixa de produção: keystore, assinatura, versionamento e envio.' },
  { frag: '06-git-ci.html',       emoji: '🔁', nav: 'Git & Esteira de Entrega',       desc: 'Do commit à loja sem tocar em nada: Git no dia a dia, Git Flow, e a esteira de CI/CD com lint, Detekt, Sonar e deploy na Play.' },
