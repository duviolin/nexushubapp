...
const articles = [
  ...
  { frag: '05-compose.html',      emoji: '🎨', nav: 'Jetpack Compose',              desc: 'A UI como função do estado, do básico ao fundo: composables e Modifier, o modelo de layout (incl. ConstraintLayout e Layout custom), estado, recomposição/estabilidade, side-effects, performance, animação e efeitos visuais.' },
